<x-global>
    <div class="container mt-5 pt-4">
        ...
        <p>Liczba dostępnych egzemplarzy: {{ $reservation->room->beds_amount }}</p>
        <p>Cena: {{$reservation->room->price}} zł/doba</p>

        <h3 class="mt-5">Oferta:</h3>
        <p>Rodzaj dostawy: {{$reservation->room->offer->accommodationType}}</p>
        <p>Lokalizacja: {{$reservation->room->offer->place}}</p>
